      ...
      <>
        ...
        <div className="flex flex-wrap gap-3 p-4 bg-[#FF5200]">
          ...
          >
            ...
            {isFilterMenuOpen && (
              <div
                className="absolute top-12 left-0 w-56 bg-white border border-gray-300 rounded-lg shadow-lg z-10"
          ...
          >
            ...
            {isSortMenuOpen && (
              <div
                className="absolute top-12 left-0 w-36 sm:w-72 bg-white border border-gray-300 rounded-lg shadow-lg z-10"
                onClick={(e) => e.stopPropagation()}
              >
